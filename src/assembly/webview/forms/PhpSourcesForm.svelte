	...
	{#if $preferenceExpanded}
		<div>
			<div class="mb-2 sans-lh">
				...
				containing files required to run the application.
				<br />
				Do not include composer's vendor directory, tests, documentation, unnecessary configs, etc.
			</div>
			<textarea class="input-text rounded mono-family lh-normal w-full" rows="2" bind:this={textareaElement} bind:value={$phpPathsForBuildText} />
		</div>
